...
export async function POST(
  ...
  try {
    ...
    await db.delete(unavailableDates).where(eq(unavailableDates.doctorId, doctorId));
    ...
    return NextResponse.json({ error: 'Failed to update unavailable dates' }, { status: 500 });
  }
} 